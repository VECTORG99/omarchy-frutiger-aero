...
- `colors.toml` (repo root, light) and `config/omarchy/themes/frutiger-aero-dark/colors.toml` — palette is the theme contract; changing colors affects all downstream configs.
